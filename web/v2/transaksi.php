<?php
$url = 'https://larakostpulsa.com/api/pembelian/transaction';
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
	$data = array( 
		...
		'target' => $_GET['target'], // Nomor Handphone / ID Pelanggan 
		'api_idtrx' => $_GET['trxid'], // Trxid / Reffid dari sisi client
	);
